...
(* $NKTestDataDir is set EAGERLY in TestRunner.wl after loading this file.
   All baseline functions use it instead of the lazy $InputFileName.          *)
$NKTestDataDir = ""  (* will be overwritten by TestRunner.wl with the real path *)

NKLoadBaseline[] :=
  Module[{path = FileNameJoin[{$NKTestDataDir, "PerformanceBaseline.wl"}]},
    If[FileExistsQ[path],
